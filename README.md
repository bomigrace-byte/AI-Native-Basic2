...
- 결과 파일명/링크:
	...
	- Scene01(Pollo)_motion.mp4
	- Scene01_narration(Eleven Labs).mp3
	- Scene01_soundeffect-cityabientnight(Pixabay).mp3
```
...
- 결과 파일명/링크:
	...
	- Scene02(Pollo)_motion.mp4
	- Scene02_narration(Eleven Labs).mp3
	- Scene02,03,04_soundeffect-birdchipping(Pixabay).mp3
	- Scene02,03,04_soundeffect-soft wind(Pixabay).mp3
```
https://github.com/user-attachments/assets/e7f4f123-824a-447c-83d6-35d276fd2306
...
- 결과 파일명/링크:
	- Scene04_keyvisual.png
	- Scene04(Google Flow)_motion.mp4
	- Scene03,04_bgm-Piano(Suno).mp3
	- Scene02,03,04_soundeffect-birdchipping(Pixabay).mp3
	- Scene02,03,04_soundeffect-soft wind(Pixabay).mp3
```
https://github.com/user-attachments/assets/d11c4ed9-1fbf-4d9d-9741-9dd1fc99ec0a
...
- 편집 범위: 컷 편집, 오디오 레이어
```
 <img width="200" height="440" alt="Capcut 작업 사진" src="https://github.com/user-attachments/assets/03eacd65-af9d-4225-b59c-50809eacd680" />
...
- 코덱: H.264 / AAC
```
**최종 영상은 10MB 제한으로 github 별도로 업로드 하였습니다.**
...
https://github.com/user-attachments/assets/4c52e85f-2542-4b3e-981a-ae9d11bbeee0
...
**영상은 10MB 제한으로 github 별도로 업로드 하였습니다.**
